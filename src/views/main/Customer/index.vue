          ...
          <v-sheet class="customer-hero" elevation="0" rounded="xl">
            <div class="d-flex flex-column flex-md-row align-center justify-space-between">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="hero-title mb-1">顧客管理面板</h2>
                  <p class="hero-subtitle mb-0">維護顧客資料，掌握顧客資訊。</p>
                </div>
              </div>
      ...
      <v-row class="summary-row" dense>
        <v-col cols="12" sm="6" md="4">
          <v-card class="summary-card" variant="tonal" color="primary">
            <div class="summary-card__title">顧客總人數</div>
            <div class="summary-card__value">{{ totalCount }}</div>
            <div class="summary-card__caption">目前已建立的顧客數量</div>
          </v-card>
        </v-col>
        <v-col cols="12" sm="6" md="4">
          <v-card class="summary-card" variant="tonal" color="secondary">
            ...
            <div class="summary-card__caption">未停權、可登入系統的顧客</div>
          </v-card>
        </v-col>
        <v-col cols="12" md="4">
          <v-card class="summary-card" variant="tonal" color="info">
            <div class="summary-card__title">停權 / 暫停</div>
            <div class="summary-card__value">{{ suspendedCount }}</div>
            <div class="summary-card__caption">勾選停權的顧客</div>
          </v-card>
        </v-col>
      </v-row>
...
const onFileSelected = async (event) => {
  ...
  if (errorMsg == "") {
    ...
    //執行上傳圖片，接受狀態
    const rs = await onUpload(`customer`) // 上傳圖片到customer資料庫
